#ifndef COMMON_LAMBERTIAN_LIGHTING_PASS_INCLUDED
#define COMMON_LAMBERTIAN_LIGHTING_PASS_INCLUDED
...
Varryings LambertianLighting_Vertex (Attributes IN) {
	Varryings OUT; 
...
float4 LambertianLighting_Fragment (Varryings IN) : SV_TARGET {
