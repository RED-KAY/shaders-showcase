#ifndef COMMON_CEL_SHADING_TEXTURE_PASS_INCLUDED
#define COMMON_CEL_SHADING_TEXTURE_PASS_INCLUDED
...
Varryings CelShadingTexture_Vertex (Attributes IN) {
	Varryings OUT; 
...
float4 CelShadingTexture_Fragment (Varryings IN) : SV_TARGET {
