#ifndef COMMON_TOON_SHADING_PASS_INCLUDED
#define COMMON_TOON_SHADING_PASS_INCLUDED
...
Varryings ToonShading_Vertex (Attributes IN) {
	Varryings OUT; 
...
float4 ToonShading_Fragment (Varryings IN) : SV_TARGET {
