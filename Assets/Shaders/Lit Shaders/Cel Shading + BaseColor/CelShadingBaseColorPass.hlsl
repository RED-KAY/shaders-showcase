#ifndef COMMON_CEL_SHADING_BASE_COLOR_PASS_INCLUDED
#define COMMON_CEL_SHADING_BASE_COLOR_PASS_INCLUDED
...
Varryings CelShadingBaseColor_Vertex (Attributes IN) {
	Varryings OUT; 
...
float4 CelShadingBaseColor_Fragment (Varryings IN) : SV_TARGET {
